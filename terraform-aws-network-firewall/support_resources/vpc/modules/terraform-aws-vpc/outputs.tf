...
output "firewall_subnets" {
  description = "List of IDs firewall subnets"
...
output "intra_subnets_tags" {
  value = try(aws_subnet.intra[*].tags_all, "")
}

output "private_subnets_tags" {
  value = try(aws_subnet.private[*].tags_all, "")
}

output "public_subnets_tags" {
  value = try(aws_subnet.public[*].tags_all, "")
}

output "db_subnets_tags" {
  value = try(aws_subnet.database[*].tags_all, "")
}

output "redshift_subnets_tags" {
  value = try(aws_subnet.redshift[*].tags_all, "")
}

output "elasticache_subnets_tags" {
  value = try(aws_subnet.elasticache[*].tags_all, "")
}

output "outpost_subnets_tags" {
  value = try(aws_subnet.outpost[*].tags_all, "")
}